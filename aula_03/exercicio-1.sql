...
-- voltar para acrescentar nos atributos de tb personagens o uid.classe
-- db não está iniciado
-- nenhuma tb está iniciada
-- inner join simplesmente traz só itens que tenham relacionamento exemplo: um produto que tem descricao
